          ...
          <a href="https://filtrd.co" className="cursor-pointer">
            <div className="my-4 p-2 max-w-2xl flex hover-up border border-gray-400 shadow-md rounded">
              ...
              <div className="sm:ml-6 flex flex-col">
                ...
                <p>
                  A website for discovering the best coffee shops and roasters.
                </p>
              </div>
            </div>
          </a>
      ...
      <section className="mt-8 mx-4 ">
        ...
        <div className="flex flex-wrap">
          <div className="p-2 w-1/2 flex items-center">
            ...
            <h3 className="ml-2 font-semibold ">HTML</h3>
          </div>
          <div className="p-2 w-1/2 flex items-center">
            <svg className="h-10 w-10" viewBox="0 0 128 128">
              <path
            ...
            <h3 className="ml-2 font-semibold ">CSS</h3>
          </div>
          <div className="p-2 w-1/2 flex items-center">
            <svg className="h-10 w-10" viewBox="0 0 128 128">
              <path
            ...
            <h3 className="ml-2 font-semibold ">JavaScript</h3>
          </div>
          <div className="p-2 w-1/2 flex items-center">
            <svg className="h-10 w-10" viewBox="0 0 128 128">
            ...
            <h3 className="ml-2 font-semibold ">ReactJS</h3>
          </div>
          <div className="p-2 w-1/2 flex items-center">
            <svg className="h-10 w-10" viewBox="0 0 128 128">
              <path
            ...
            <h3 className="ml-2 font-semibold ">Node</h3>
          </div>
          <div className="p-2 w-1/2 flex items-center">
            <svg className="h-10 w-10" viewBox="0 0 128 128">
              <path
            ...
            <h3 className="ml-2 font-semibold ">PostgreSQL</h3>
          </div>
          <div className="p-2 w-1/2 flex items-center">
            <svg
              width={40}
            ...
            >
              <g clipPath="url(#clip0)">
                <path
                  d="M19.8558 0C9.70132 7.24499e-07 10.3354 4.4036 10.3354 4.4036L10.3468 8.96568H20.0369V10.3354H6.49785C6.49785 10.3354 0 9.59852 0 19.8445C-7.24499e-07 30.0905 5.67147 29.7271 5.67147 29.7271H9.05624V24.9726C9.05624 24.9726 8.87379 19.3011 14.6371 19.3011C20.4005 19.3011 24.2481 19.3011 24.2481 19.3011C24.2481 19.3011 29.6479 19.3884 29.6479 14.0825C29.6479 8.77651 29.6479 5.30922 29.6479 5.30922C29.6479 5.30922 30.4677 0 19.8558 0ZM14.5126 3.0678C15.4767 3.0678 16.256 3.84703 16.256 4.81113C16.256 5.77523 15.4767 6.55445 14.5126 6.55445C13.5485 6.55445 12.7693 5.77523 12.7693 4.81113C12.7693 3.84703 13.5485 3.0678 14.5126 3.0678Z"
                  fill="url(#paint0_linear)"
                />
                <path
                  d="M20.1442 39.7917C30.2987 39.7917 29.6646 35.3881 29.6646 35.3881L29.6532 30.826H19.9631V29.4563H33.5022C33.5022 29.4563 40 30.1932 40 19.9472C40 9.70125 34.3285 10.0646 34.3285 10.0646H30.9438V14.8191C30.9438 14.8191 31.1262 20.4906 25.3629 20.4906C19.5995 20.4906 15.7519 20.4906 15.7519 20.4906C15.7519 20.4906 10.3521 20.4033 10.3521 25.7093C10.3521 31.0152 10.3521 34.4825 10.3521 34.4825C10.3521 34.4825 9.5323 39.7917 20.1442 39.7917ZM25.4874 36.7239C24.5233 36.7239 23.7441 35.9447 23.7441 34.9806C23.7441 34.0165 24.5233 33.2373 25.4874 33.2373C26.4515 33.2373 27.2307 34.0165 27.2307 34.9806C27.2307 35.9447 26.4515 36.7239 25.4874 36.7239Z"
              ...
              <defs>
                ...
                <clipPath id="clip0">
                  <rect width={40} height="39.7917" fill="white" />
                </clipPath>
              </defs>
            </svg>

            <h3 className="ml-2 font-semibold ">Python</h3>
          </div>
          <div className="p-2 flex items-center">
            ...
            <h3 className="ml-2 font-semibold ">GatsbyJS</h3>
          </div>
        </div>
      </section>
